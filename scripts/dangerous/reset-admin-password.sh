#!/bin/bash
#
# DANGEROUS — resets local admin credentials to a known default (anna / admin).
#
# Safe environment: local DDEV only.
# Destructive: YES — overwrites account password and role assignments.
# Required confirmation: confirm this is a local dev reset, not staging/production.
#
set -e
