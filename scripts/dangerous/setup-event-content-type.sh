#!/bin/bash
#
# DANGEROUS — deletes the event content type and recreates fields from scratch.
#
# Safe environment: local DDEV only, empty or disposable event data.
# Destructive: YES — deleting the event bundle removes related field data.
# Required confirmation: export DB; confirm no production/staging data will be lost.
#
