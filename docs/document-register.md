...
| Vendor Studio Acceptance Initiative Brief | `docs/product/initiatives/TRACE-NOW-02-vendor-studio-acceptance.md` | Active product governance | Acceptance-only initiative boundary | Acceptance evidence recorded; decision pending | Product Owner | Unknown | 2026-07-26 | Product Delivery Traceability | Keep |
...
| VL-5 Acceptance Review | `docs/design/vendor-studio-visual/reviews/vl5/README.md` | Design assurance | Launch Success and ticket workspace acceptance evidence | Conditional evidence; Product Owner decision pending | Product Owner | Unknown | 2026-07-26 | Vendor Component Catalogue; TRACE-NOW-02 | Keep |
