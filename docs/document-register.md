...
| Operations Ownership and Verification Initiative Brief | `docs/product/initiatives/TRACE-NOW-05-operations-baseline.md` | Active product governance | Operations verification boundary | Baseline approved; role assignments pending | Product Owner | Unknown | 2026-07-26 | Product Delivery Traceability; Operations | Keep |
| Customer Experience Acceptance Refresh | `docs/product/initiatives/TRACE-NOW-03-customer-experience-acceptance.md` | Active product governance | Customer journey acceptance boundary | Controlled RSVP evidence complete; investigation decisions required; implementation not authorised | Product Owner | Unknown | 2026-07-27 | Product Delivery Traceability; Product Requirements | Keep |
| Checkout Acceptance Refresh | `docs/product/initiatives/TRACE-NOW-04-checkout-acceptance.md` | Active product governance | Checkout and payment acceptance boundary | Approved for bounded evidence collection; implementation not authorised | Product Owner | Unknown | 2026-07-26 | Product Delivery Traceability; Product Requirements | Keep |
| Customer Experience Acceptance Refresh Evidence | `docs/launch/customer-verification/2026-07-27-customer-experience-acceptance-refresh.md` | Product assurance | Current customer journey evidence and decision register | Controlled RSVP evidence complete; investigation decisions required | Product Owner | Unknown | 2026-07-27 | TRACE-NOW-03; Product Requirements | Needs Product Owner decision |
...
| Operations Ownership and Verification Baseline | `docs/operations/operations-ownership-verification-baseline.md` | Operational assurance | System ownership and verification baseline | Product Owner approved; accountable roles pending | Product Owner | Unknown | 2026-07-26 | MyEventLane Operations; TRACE-NOW-05 | Keep |
| Operational Accountability Model | `docs/operations/operational-accountability-model.md` | Operational governance proposal | Recommended roles and decision rights | Recommended; Product Owner approval pending | Unknown | Unknown | 2026-07-26 | MyEventLane Operations; Operations Ownership Baseline | Needs Product Owner decision |
| Deferred Operational Configuration Requirements | `docs/operations/deferred-operational-configuration-requirements.md` | Operational requirements | Deferred configuration and safety boundary | Deferred; implementation not authorised | Product Owner | Unknown | 2026-07-26 | MyEventLane Operations; Operational Accountability Model | Keep |
