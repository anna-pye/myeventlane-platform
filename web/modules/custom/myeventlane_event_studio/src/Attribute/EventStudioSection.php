...
final class EventStudioSection extends Plugin {
  ...
  public function __construct(
    ...
    public readonly ?bool $supports_autosave = NULL,
    public readonly ?bool $supports_publish = NULL,
    public readonly ?bool $supports_readiness = NULL,
    public readonly ?bool $supports_mobile_priority = NULL,
