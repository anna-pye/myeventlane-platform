...
final class DirectChargeCopyContractTest extends TestCase {
  ...
  private const ACTIVE_SURFACES = [
    ...
    'web/modules/custom/myeventlane_vendor/src/Controller/StripeConnectController.php',
    ...
    'web/modules/custom/myeventlane_vendor/src/Form/StripeAccountReconnectForm.php',
