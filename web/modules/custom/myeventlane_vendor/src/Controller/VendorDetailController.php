...
final class VendorDetailController extends ControllerBase {
  ...
  public function view(Vendor $myeventlane_vendor): array {
    ...
    $is_authenticated = (int) $this->currentUser->id() > 0;
    ...
    $build = [
      ...
      '#is_following' => $is_authenticated ? $this->vendorFollowService->isFollowing($this->currentUser, $myeventlane_vendor) : FALSE,
