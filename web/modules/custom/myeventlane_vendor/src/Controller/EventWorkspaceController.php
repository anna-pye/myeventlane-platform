...
final class EventWorkspaceController extends VendorConsoleBaseController {
  ...
  /**
   * Constructs the event workspace controller.
   */
  ...
  /**
   * Workspace root route: redirect to canonical overview tab.
   */
  public function workspace(NodeInterface $event): RedirectResponse {
    $this->assertEventOwnership($event);

    $target = Url::fromRoute('myeventlane_vendor.console.event_overview', [
      'event' => (int) $event->id(),
    ])->toString();
