...
final class EventSuggestionEngine {
  ...
  private function wizardTicketsAction(NodeInterface $event, string $label): ?array {
    try {
      ...
      return $this->formatter->helpActionLink('ticket_types', (string) $this->t('Learn more'));
    }
  }
  ...
  private function wizardWhenWhereAction(NodeInterface $event, string $label): ?array {
    try {
      ...
      return $this->formatter->helpActionLink('rsvp_vs_paid', (string) $this->t('Learn more'));
    }
  }
  ...
  private function wizardDetailsAction(NodeInterface $event, string $label): ?array {
    try {
      ...
      return $this->formatter->helpActionLink('event_create', (string) $this->t('Learn more'));
    }
  }
