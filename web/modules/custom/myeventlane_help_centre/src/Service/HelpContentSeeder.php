  ...
  public function seedHelpArticles(): int {
    $articles = [
      ...
      [
        ...
        'summary' => 'Choose ticket types that match access, pricing, and release windows.',
        'body' => '<p>Create clear ticket types such as early-bird, general release, and concession. Keep names clear so attendees can choose confidently.</p>',
        'audience' => ['Organisers', 'Vendors'],
        'topic' => 'Tickets',
        'article_type' => 'Overview',
        'keywords' => 'ticket types, early bird, general release',
        'cta_label' => 'Set ticket options',
        'cta_link' => '/dashboard',
